            ...
            <div class="nav flex justify-between p-5 border-b border-[#EEEEEE]">
                ...
                <div class="flex items-center gap-[30px]">
                    <div class="flex gap-[14px]">
                        <a href="" class="w-[46px] h-[46px] flex shrink-0 items-center justify-center rounded-full border border-[#C0C7BF]">
                            <img src="{{asset('images/icons/receipt-text.svg')}}" alt="icon" title="Receipt">
                        </a>
                        <a href="" class="w-[46px] h-[46px] flex shrink-0 items-center justify-center rounded-full border border-[#C0C7BF]">
                            <img src="{{asset('images/icons/notification.svg')}}" alt="icon" title="Nofitication">
                        </a>
                    </div>
                    <div class="h-[46px] w-[1px] flex shrink-0 border border-[#EEEEEE]"></div>
                    <div class="flex gap-3 items-center">
                        <div class="flex flex-col text-right">
                            <p class="text-sm text-[#7F8190]">Dandi Saputra</p>
            ...
            <div class="header ml-[70px] pr-[70px] w-[940px] flex items-center justify-between mt-10">
                <div class="flex gap-6 items-center">
                    <div class="w-[150px] h-[150px] flex shrink-0 relative overflow-hidden">
                        ...
                        <p class="p-[8px_16px] rounded-full bg-[#FFC7C7] font-bold text-sm text-[#D11319] absolute bottom-0 transform -translate-x-1/2 left-1/2 text-nowrap">{{ $course->category->name }}</p>
                    </div>
