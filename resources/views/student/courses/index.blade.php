            ...
            <div class="course-list-container flex flex-col px-5 mt-[30px] gap-[30px]">
                ...
                <div class="list-items flex flex-nowrap justify-between pr-10">
                    ...
                    @if($course->category->name == 'Digital Marketing')
                        ...
                        @elseif ($course->category->name == 'Cyber Security')
                        <div class="flex shrink-0 w-[170px] items-center justify-center">
                        <p class="p-[8px_16px] rounded-full bg-[#FFC7C7] font-bold text-sm text-[#D11319]">{{ $course->category->name }}</p>
                        </div>
                    ...
                    <div class="flex shrink-0 w-[120px] items-center">
                        ...
                        @else
                        <a href="{{ route('dashboard.learning.rapport.course', $course) }}" class="w-full h-[41px] p-[10px_20px] bg-indigo-900 rounded-full font-bold text-sm text-white transition-all duration-300 hover:shadow-[0_4px_15px_0_#6436F14D] text-center">Results</a>
                        @endif
                    </div>
                </div>
                @empty
                <p class="text-center font-medium text-lg">Belum memiliki kelas yang diberikan oleh guru.</p>
                @endforelse
