            ...
            <div class="result flex flex-col gap-5 mx-[70px] w-[870px] mt-[30px]">
                ...
                <div class="question-card w-full flex items-center justify-between p-4 border border-[#EEEEEE] rounded-[20px]">
                    ...
                    <div class="flex items-center gap-[14px]">
                        <p class="bg-[#06BC65] rounded-full p-[8px_20px] text-white font-semibold text-sm mr-1 capitalize">{{ $answer->answer }}</p>
                    </div>
                    @else
                    <div class="flex items-center gap-[14px]">
                        <p class="bg-[#D11319] rounded-full p-[8px_20px] text-white font-semibold text-sm capitalize">{{ $answer->answer }}</p>
                    </div>
                    @endif
                </div>
                @empty
