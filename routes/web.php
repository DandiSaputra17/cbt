...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('dashboard')->name('dashboard.')->group(function () {
        ...
        Route::get('/course/students/show/{course}', [CourseQuestionController::class, 'index'])->middleware('role:teacher')->name('course.course_students.index');

        Route::get('/course/students/create/{course}', [CourseQuestionController::class, 'create'])->middleware('role:teacher')->name('course.course_students.create');

        Route::post('/course/students/create/save/{course}', [CourseQuestionController::class, 'store'])->middleware('role:teacher')->name('course.course_students.create');
